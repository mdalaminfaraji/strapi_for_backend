...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Mangoes: Attribute.Component<'fruit-collections.collection'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    Title: Attribute.String;
    valueList: Attribute.Blocks;
    isHidden: Attribute.Boolean;
    BookList: Attribute.JSON;
    Age: Attribute.Integer;
    Email: Attribute.Email &
      Attribute.Required &
      Attribute.Unique &
      Attribute.DefaultTo<'alaminice@gmail.com'>;
    Buying: Attribute.Date;
    Password: Attribute.Password;
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    SelectedBook: Attribute.Enumeration<
      ['scientific', 'economic', 'physics', 'chemistry']
    >;
...
export interface ApiHrCommentHrComment extends Schema.CollectionType {
  collectionName: 'hr_comments';
  info: {
    singularName: 'hr-comment';
    pluralName: 'hr-comments';
    displayName: 'HrComment';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::hr-comment.hr-comment': ApiHrCommentHrComment;
